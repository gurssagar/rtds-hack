  ...
  return (
    <div className="space-y-2">
      ...
      <div className="relative">
        <input
          type="text"
          className="w-full bg-black px-4 py-2  border-0 rounded-lg focus:ring-2 focus:ring-blue-100 focus:outline-none transition-all text-sm"
      ...
      <div className="mt-2 max-h-[300px] overflow-y-auto rounded-lg">
        {filteredRegions.map((region) => (
          <button 
            key={region.id}
            type="button"
            className={`bg-black flex items-center gap-3 p-4 w-full transition-all ${
              value === region.id
