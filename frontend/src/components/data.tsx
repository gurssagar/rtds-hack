  ...
  return (
    <div className="space-y-2">
      ...
      <div className="relative">
        <input
          type="text"
          className="w-full px-4 py-2 bg-black border border-gray-800 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none transition-all text-sm text-gray-200"
          placeholder="Search regions..."
          value={searchTerm}
          onChange={(e) => setSearchTerm(e.target.value)}
        />
      </div>
      <div className="mt-2 max-h-[300px] overflow-y-auto rounded-lg border border-gray-800">
        {filteredRegions.map((region) => (
          ...
          >
            ...
            <div className="text-left flex-1">
              <div className="text-sm font-medium text-gray-200">{region.country}</div>
